...
CODEGEN_HEADER = "# AUTO-GENERATED by ninja-codegen — DO NOT EDIT"
...
def get_template_env() -> SandboxedEnvironment:
    ...
    (SSTI) when entity or field names contain Jinja2 syntax.  Autoescape is
    left disabled because templates emit Python source code, not HTML.
    """
    global _env
    if _env is None:
